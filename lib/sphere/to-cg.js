(function(){
  ...
  var barycenterVerticesAndFaces = function(Sphere, options){
    ...
    aux[0] = colorFn.call(Sphere._North, Sphere._North.data, Sphere._North._pos, Sphere._North._sxy);
    aux[1] = colorFn.call(Sphere._South, Sphere._South.data, Sphere._South._pos, Sphere._South._sxy);
