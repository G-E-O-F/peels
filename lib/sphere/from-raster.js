...
/**
 * Returns a two-dimensional array of booleans indicating which pixel corners lay inside
 * a field's edges.
 *
 * @param geo - result of `_fieldGeometry` analysis
 * @param w - width of the dataset
 * @param h - height of the dataset
 * @returns {{min_x: number, max_x: number, min_y: number, max_y: number, grid: Array}}
 * @private
 */
 ...
 * Field's edges.
 *
 * @param grid – result of `_populateSelectionGrid`
